...
set "SANKAKU_DISABLE_WEBENGINE=1"
"%~dp0Runtime\python.exe" -s -c "import os,runpy,sys;p=os.environ['SANKAKU_APP_DIR'];sys.path.insert(0,p);runpy.run_path(os.path.join(p,'run_tests.py'),run_name='__main__')"
exit /b %ERRORLEVEL%
